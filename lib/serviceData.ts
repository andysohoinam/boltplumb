...
export const serviceDetails: Record<string, ServiceDetail> = {
  'toilet-bowl-choke-repair': {
    ...
    metaDescription:
      'Professional toilet bowl choke repair in Singapore. Homeaspect provides fast toilet unblocking for HDB flats and condos. Same-day service in Tampines, Bedok, Jurong and across Singapore.',
  ...
  'water-heater-repair': {
    ...
    metaDescription:
      'Water heater repair and replacement in Singapore by Homeaspect. Service for instant and storage water heaters in HDB, condo units. Same-day repair available.',
  ...
  'sink-choke-repair': {
    ...
    metaDescription:
      'Professional sink choke repair in Singapore. Homeaspect clears blocked kitchen and bathroom sinks fast. Same-day service across HDB and condo units.',
    ...
    overview:
      'A blocked sink disrupts your daily routine and can cause unpleasant odours, water backup, and potential water damage to cabinets and flooring beneath the sink. Whether it is your kitchen sink clogged with food debris and grease, or a bathroom basin blocked with soap scum and hair, Homeaspect provides fast and effective sink choke repair services for homes across Singapore. Kitchen sink blockages differ significantly from bathroom sink chokes due to the nature of debris involved—kitchen chokes typically involve hardened grease, food particles, and occasionally utensil damage, while bathroom sinks usually accumulate hair, soap scum, toothpaste, and skincare products. Both require professional expertise to clear without damaging delicate sink traps and pipes. We understand that your kitchen and bathroom sinks are essential to daily hygiene, food preparation, and cleaning, so we prioritize same-day service and rapid response. Our technicians carry professional-grade equipment including mechanical augers, plumbing snakes, and access tools that clear blockages safely without harsh chemical drain cleaners that damage pipes. We serve HDB units in all neighborhoods including Bedok, Woodlands, and Sengkang, as well as private properties and condominium units throughout Singapore.',
    commonIssues: [
      {
  ...
  'floor-trap-choke-repair': {
    ...
    metaDescription:
      'Professional floor trap choke clearing in Singapore by Homeaspect. Fast bathroom and kitchen floor drain unblocking. Same-day service for HDB and condo units.',
  ...
  'tap-repair': {
    ...
    metaDescription:
      'Tap repair and replacement in Singapore by Homeaspect. Fix leaking taps, install new fixtures, restore water flow. Same-day service for HDB and condo units.',
  ...
  'basin-replacement': {
    ...
    metaDescription:
      'Professional basin replacement and installation in Singapore by Homeaspect. Installation for HDB and condo bathrooms and kitchens. Same-day service available.',
