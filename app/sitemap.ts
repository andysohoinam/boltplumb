...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    { url: `${SITE_URL}/emergency`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },
    ...
    { url: `${SITE_URL}/projects`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
